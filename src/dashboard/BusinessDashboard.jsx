...
export default function BusinessDashboard({ businessId: propBusinessId = null }) {
  ...
  const { handleCreateCardForList, handleUpdateCard, handleDeleteCard, handleMoveCard } = useCardHandlers({ businessId, uid, dispatchSet, selectedBoardId, cardsMap, lists, canEditBoardValue, canAssignTasks, newCardInputs });
